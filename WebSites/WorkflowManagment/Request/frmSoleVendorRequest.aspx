...
<asp:Content ID="content" ContentPlaceHolderID="DefaultContent" runat="Server">
    ...
    <div class="jarviswidget" id="wid-id-8" data-widget-editbutton="false" data-widget-custombutton="false">
        <header>
            ...
            <h2>Choose the Item for Sole Vendor Request</h2>
        </header>
        <div>
                ...
                <div class="smart-form">
                    ...
                    <asp:Panel ID="pnlInfo" runat="server">
                        <div class="alert alert-info fade in">
                            ...
                            <strong>Info!</strong> Please select the Purchase Request Transaction to perform Sole Vendor Form
                        </div>
                    </asp:Panel>
    ...
    <div id="wid-id-9" class="jarviswidget" data-widget-custombutton="false" data-widget-editbutton="false">
        <header>
            <span class="widget-icon"><i class="fa fa-edit"></i></span>
                    ...
                    <fieldset>
                        <div class="row">
                            ...
                            <section class="col col-6">
                                ...
                                <label class="input">
                                    <asp:TextBox ID="txtComment" TextMode="MultiLine" Width="100%" runat="server"></asp:TextBox>
                                </label>
                            </section>
                        </div>
                    </fieldset>
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    <asp:DataGrid ID="dgSoleVenderDetail" runat="server" AlternatingRowStyle-CssClass="" AutoGenerateColumns="False" CellPadding="0"
                                                        ...
                                                        OnPageIndexChanged="dgSoleVenderDetail_PageIndexChanged" OnSelectedIndexChanged="dgSoleVenderDetail_SelectedIndexChanged" OnUpdateCommand="dgSoleVenderDetail_UpdateCommand" OnEditCommand="dgSoleVenderDetail_EditCommand">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="Reason For Selection">
                                                                ...
                                                                <EditItemTemplate>
                                                                    <asp:TextBox ID="txtEdtReason" runat="server" CssClass="form-control" Visible="true" Text=' <%# DataBinder.Eval(Container.DataItem, "ReasonForSelection")%>'></asp:TextBox>
                                                                    <asp:RequiredFieldValidator ID="RfvReas" runat="server" CssClass="validator" ControlToValidate="txtEdtReason" ErrorMessage="Reason For Selection Required" ValidationGroup="proedit">*</asp:RequiredFieldValidator>
                                                                </EditItemTemplate>
                                                            </asp:TemplateColumn>
