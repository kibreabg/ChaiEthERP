...
namespace Chai.WorkflowManagment.Modules.Request.Views
{
    public partial class frmLeaveRequest : POCBasePage, ILeaveRequestView
    {
                    ...
                    if (ddlLeaveType.SelectedItem.Text != "Annual Leave")
                    {
                        ...
                        else if (ddlLeaveType.SelectedItem.Text == "Sick Leave" || ddlLeaveType.SelectedItem.Text == "Exam Leave" || ddlLeaveType.SelectedItem.Text != "Maternity Leave" || ddlLeaveType.SelectedItem.Text == "Paternity Leave" || ddlLeaveType.SelectedItem.Text == "Other Leaves")
                        {
                            if (_presenter.CurrentLeaveRequest.FilePath != "")
                            {
                                ...
                                {
                                    Master.ShowMessage(new AppMessage("Please contact HR, Your Sick Leave balance exceeded from your Entitlement", RMessageType.Error));
                                }
                            }
                            else
                            {
                                Master.ShowMessage(new AppMessage("Please Attach  letter", RMessageType.Error));
                            }
        ...
        protected void ddlLeaveType_SelectedIndexChanged1(object sender, EventArgs e)
        {
            ...
            else if (ddlLeaveType.SelectedItem.Text.Contains("Sick Leave") || ddlLeaveType.SelectedItem.Text.Contains("Exam Leave") || ddlLeaveType.SelectedItem.Text.Contains("Other Leaves") || ddlLeaveType.SelectedItem.Text.Contains("Maternity Leave") || ddlLeaveType.SelectedItem.Text == "Paternity Leave")
            {
