...
<asp:Content ID="content" ContentPlaceHolderID="DefaultContent" runat="Server">
    <div class="jarviswidget" id="wid-id-6" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false" role="widget" style="">
        <header role="heading">
                                            ...
                                            <asp:GridView ID="dgContractDetail" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField ShowHeader="False">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkDelete" runat="server" CausesValidation="False" CommandName="Select" Text="Delete" OnClick="lnkDelete_Click"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <asp:Button ID="btnPAFNew" runat="server" CssClass="btn btn-primary" Text="Generate PAF" OnClientClick="javascript:Clickheretoprint('divprint2')" Visible="False" />
                                             <asp:Button ID="btnPAFChange" runat="server" CssClass="btn btn-primary" Text="Generate PAF" OnClientClick="javascript:Clickheretoprint('divprint')" Visible="False" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <asp:GridView ID="dgChange" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                            ...
                                            PagerStyle-CssClass="paginate_button active" AlternatingRowStyle-CssClass=""
                                            Width="100%" Style="text-align: left"
                                            AllowPaging="True" PageSize="20" OnSelectedIndexChanged="dgChange_SelectedIndexChanged1">
                                            <Columns>
                                                <asp:BoundField DataField="JobTitle.JobTitleName" HeaderText="Job Title" />
                                                ...
                                                <asp:TemplateField ShowHeader="False">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkDeleteemp" runat="server" CausesValidation="False" CommandName="Select" Text="Delete" OnClick="lnkDeleteemp_Click" ></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                            </Columns>
                                            <PagerStyle CssClass="paginate_button active" HorizontalAlign="Center" />
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <fieldset>
                                            <asp:GridView ID="dgTermination" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                                ...
                                                PagerStyle-CssClass="paginate_button active" AlternatingRowStyle-CssClass=""
                                                Width="100%" Style="text-align: left"
                                                AllowPaging="True" PageSize="20" OnSelectedIndexChanged="dgTermination_SelectedIndexChanged">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField ShowHeader="False">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkDeleteter" runat="server" CausesValidation="False" CommandName="Select" Text="Delete" OnClick="lnkDeleteter_Click" ></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
