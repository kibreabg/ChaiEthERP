<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmExportCostSharingPayment.aspx.cs" Inherits="Chai.WorkflowManagment.Modules.Report.Views.frmExportCostSharingPayment"
...
<asp:Content ID="content" ContentPlaceHolderID="DefaultContent" runat="Server">
    <div class="jarviswidget" id="wid-id-8" data-widget-editbutton="false" data-widget-custombutton="false">
        <header>
            ...
            <h2>Export Cost Sharing Payment</h2>
        </header>
        <div>
