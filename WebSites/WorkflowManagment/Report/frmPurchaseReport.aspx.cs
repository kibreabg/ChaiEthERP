...
namespace Chai.WorkflowManagment.Modules.Report.Views
{
    public partial class frmPurchaseReport : POCBasePage, IfrmpurchaseReportView
    {
        ...
        private void ViewPurchaseReport()
        {
            ...
            rvPurchaseReport.ProcessingMode = ProcessingMode.Local;
            rvPurchaseReport.LocalReport.DataSources.Clear();
            rvPurchaseReport.LocalReport.DataSources.Add(s);
            rvPurchaseReport.LocalReport.ReportPath = path;
            ...
            rvPurchaseReport.LocalReport.SetParameters(parameters);
        ...
        {
            pnlPurchaseReport.Visible = true;
            ViewPurchaseReport();
        }
    }
}
