<%@ Page Title="Item Receive" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" CodeFile="frmReceive.aspx.cs" Inherits="Chai.WorkflowManagment.Modules.Inventory.Views.frmReceive" %>
...
<asp:Content ID="content" ContentPlaceHolderID="DefaultContent" runat="Server">
                ...
                <div class="smart-form">
                    <fieldset>
                        <div class="row">
                            <section class="col col-6">
                                ...
                                <label class="input">
                                    ...
                                    <asp:TextBox ID="txtReceiveDate" ReadOnly="true" runat="server"></asp:TextBox>
                                </label>
                            </section>
                            <section class="col col-6">
                                <label class="label">Delivered By</label>
                                <label class="input">
                                    <asp:TextBox ID="txtDeliveredBy" Width="100%" runat="server"></asp:TextBox>
                                </label>
                            </section>
                        </div>
                        <div class="row">
                            ...
                            <section class="col col-6">
                                ...
                                <label class="select">
                                    <asp:DropDownList ID="ddlSupplier" runat="server" DataTextField="SupplierName" AppendDataBoundItems="true" DataValueField="Id">
                        ...
                        <div class="row">
                            ...
                            <section class="col col-6">
                                <label class="label">Grant ID</label>
                                <label class="select">
                        ...
                        <div class="row">
                            <section class="col col-6">
                                ...
                                <label class="input">
                                    <asp:TextBox ID="txtInvoiceNo" Width="100%" runat="server"></asp:TextBox>
                                </label>
                            </section>
                            <section class="col col-6">
                            </section>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="hr1">
                                    <ul class="nav nav-tabs">
                                        <li class="active">
                                            <a href="#iss1" data-toggle="tab">Receive Details</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content padding-10">
                                        <div class="tab-pane active" id="iss1">
                                            <asp:GridView ID="grvReceiveDetails"
                                                runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
                                                OnSelectedIndexChanged="grvReceiveDetails_SelectedIndexChanged"
                                                AllowPaging="True" OnPageIndexChanging="grvReceiveDetails_PageIndexChanging"
                                                CssClass="table table-striped table-bordered table-hover" PagerStyle-CssClass="paginate_button active" PageSize="5" OnRowDataBound="grvReceiveDetails_RowDataBound">
    ...
    <div class="modal fade" id="receiveDetailModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" style="width: 800px;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        &times;</button>
                    <h4 class="modal-title" id="myDetailModalLabel">Add Item Receive Detail</h4>
                </div>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Search Item Receives</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="well well-sm well-primary">
                                    <asp:GridView ID="grvReceiveList"
                                        runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
                                        OnSelectedIndexChanged="grvReceiveList_SelectedIndexChanged"
                                        AllowPaging="True" OnPageIndexChanging="grvReceiveList_PageIndexChanging"
                                        CssClass="table table-striped table-bordered table-hover" PagerStyle-CssClass="paginate_button active" PageSize="5" OnRowDataBound="grvReceiveList_RowDataBound">
                                        <RowStyle CssClass="rowstyle" />
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Receive Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDate" runat="server" Text='<%# Eval("ReceiveDate", "{0:dd/MM/yyyy}")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="DeliveredBy" HeaderText="Deliver By" SortExpression="DeliveredBy" />
                                            <asp:BoundField DataField="Program.ProgramName" HeaderText="Program" SortExpression="Program.ProgramName" />
                                            <asp:CommandField ShowSelectButton="True" />
                                        </Columns>
                                        <FooterStyle CssClass="FooterStyle" />
                                        <HeaderStyle CssClass="headerstyle" />
