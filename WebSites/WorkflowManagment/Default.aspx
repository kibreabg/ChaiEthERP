                        ...
                        <div class="widget-body no-padding smart-form">
                            ...
                            <ul id="sortable3" class="todo">
                                ...
                                <li class="">
                                    <span class="handle" style="display: none"></span>
                                    <p>
                                        <asp:Label ID="lblExpenseLiquidationMyRequest" runat="server" Text="Travel Expense Liquidation Request" CssClass="label"></asp:Label>-
                                ...
                                <li class="">
                                    <span class="handle" style="display: none"></span>
                                    <p>
                                        <asp:Label ID="lblPaymentReimburesmentMyRequest" runat="server" Text="Cash Payment Settlement Request" CssClass="label"></asp:Label>-
                                ...
                                <li class="">
                                    ...
                                    <p>
                                        <asp:Label ID="lblMaintenanceMyRequest" runat="server" Text="Maintenance Request" CssClass="label"></asp:Label>-
                                            <asp:Label ID="lblMaintenanceStatus" runat="server" Text="No Request"></asp:Label>
                                    </p>
                                ...
                                <li class="">
                                    ...
                                    <p>
                                        <asp:Label ID="lblStoreMyRequest" runat="server" Text="Store Request" CssClass="label"></asp:Label>-
                                            <asp:Label ID="lblStoreStatus" runat="server" Text="No Request"></asp:Label>
                                    </p>
                                    <a data-toggle="modal" runat="server" id="A13" href="#storeModal">Progress Detail</a>
                                </li>
                            </ul>
                        ...
                        <div class="widget-body no-padding smart-form">
                            ...
                            <ul id="sortable3" class="todo">
                                ...
                                <li class="">
                                    <span class="handle" style="display: none"></span>
                                    <p>
                                        <asp:LinkButton ID="lnkreviewliquidation" runat="server" Text="Review Travel Liquidation" Enabled="false"></asp:LinkButton>
                                ...
                                <li class="">
                                    <span class="handle" style="display: none"></span>
                                    <p>
                                        <asp:LinkButton ID="lnkExpenseLiquidation" runat="server" Text="Travel Expense Liquidation" Enabled="false"></asp:LinkButton>
                                    ...
                                    <span class="handle" style="display: none"></span>
                                    <p>
                                        <asp:LinkButton ID="lnkReviewpaymentsettlemnt" runat="server" Text="Review Cash Payment Settlement" Enabled="false"></asp:LinkButton>
                                ...
                                <li class="">
                                    <span class="handle" style="display: none"></span>
                                    <p>
                                        <asp:LinkButton ID="lnkPaymentReimbursement" runat="server" Text="Cash Payment Settlement" Enabled="false"></asp:LinkButton>
                                ...
                                <li class="">
                                    ...
                                    <p>
                                        ...
                                        (<small class="num-of-tasks"><asp:Label ID="lblMaintenanc" runat="server" Text=""></asp:Label></small>)
                                    </p>
                                </li>
                                <li class="">
                                    <span class="handle" style="display: none"></span>
                                    <p>
                                        <asp:LinkButton ID="lnkStore" runat="server" Text="Store Requests" Enabled="false"></asp:LinkButton>
                                        (<small class="num-of-tasks"><asp:Label ID="lblStore" runat="server" Text=""></asp:Label></small>)
                                    </p>
                                </li>
                            </ul>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myExpenseModalLabel">Travel Expense Liquidation Approval Progress</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myMaintenanceModalLabel">Maintenance Approval Progress</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myStoreModalLabel">Store Approval Progress</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
