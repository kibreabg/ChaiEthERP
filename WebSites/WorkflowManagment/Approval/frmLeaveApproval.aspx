<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" Async="true" CodeFile="frmLeaveApproval.aspx.cs" Inherits="Chai.WorkflowManagment.Modules.Approval.Views.frmLeaveApproval" %>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-6">
                                                ...
                                                <label class="textarea">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvRejectedReason" runat="server" Enabled="false" CssClass="validator" ValidationGroup="Approve" ErrorMessage="Please Enter Rejection Reason" ControlToValidate="txtRejectedReason"></asp:RequiredFieldValidator>
                                                </label>
                                            </section>
                                        </div>
                                    </fieldset>
