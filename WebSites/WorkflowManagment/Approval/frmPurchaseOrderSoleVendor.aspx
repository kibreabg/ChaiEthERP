                    ...
                    <table border="1">
                        ...
                        <tr>
                            <b>
                                ...
                                <td>
                                    <asp:Label ID="lblSupplierAddress" runat="server" Text=""></asp:Label></td>
                                <td></td>
                                <td></td>
                            </b>
                        </tr>
                        <tr>
                            <b>
                                ...
                                <td>
                                    <asp:Label ID="lblSupplierContactP" runat="server" Text=""></asp:Label></td>
                                <td></td>
                                <td></td>
                            </b>
                        </tr>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 617px">
                            <asp:Label ID="lblRequestNoResult" runat="server"></asp:Label></td>
                        <td class="modal-sm" style="width: 404px">Purpose</td>
                        <td>
                            <asp:Label ID="lblPurposeResult" runat="server"></asp:Label></td>

                    </tr>

                    <tr>
                        <td style="width: 585px">Purchase Order No
                        </td>
                        <td style="width: 617px">
                    ...
                    <tr>
                        <td style="width: 585px">Requester
                        </td>
                        <td style="width: 617px">
                        ...
                        <td>
                            <asp:Label ID="lblDeliverToResult" runat="server"></asp:Label></td>

                    </tr>
                    <tr>
                        <td style="width: 585px">Request Date
                        </td>
                        <td style="width: 617px">
                        ...
                        <td>
                            <asp:Label ID="lblSuggestedSupplierResult" runat="server"></asp:Label></td>

                    </tr>
                    <tr>
                        <td style="width: 585px">Bill To
                        </td>
                        <td style="width: 617px">
                    ...
                    <tr>
                        <td style="width: 585px">Reason for Selection
                        </td>
                        <td style="width: 617px">
                            <asp:Label ID="lblReasonforSelectionResult" runat="server"></asp:Label>
                        </td>
                        <td class="modal-sm" style="width: 404px">Selected by</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="modal-sm" style="width: 404px">Payment Terms</td>
                        <td>
