<%@ Page Title="Vehicle Form" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" CodeFile="frmVehicle.aspx.cs" Inherits="Chai.WorkflowManagment.Modules.Setting.Views.frmVehicle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DefaultContent" runat="Server">
    ...
    <div class="jarviswidget" id="wid-id-8" data-widget-editbutton="false" data-widget-custombutton="false">
                    ...
                    <fieldset>
                        <div class="row">
                            <section class="col col-6">
                                <asp:Label ID="lblVehicleName" runat="server" Text="Plate No." CssClass="label"></asp:Label>

                                <label class="input">

                                    <asp:TextBox ID="txtSrchVehicleName" runat="server"></asp:TextBox></label>
                            </section>
                        </div>
                    </fieldset>
                    <footer>
        ...
        <asp:DataGrid ID="dgVehicle" runat="server" AlternatingRowStyle-CssClass="" AutoGenerateColumns="False" CellPadding="0"
            CssClass="table table-striped table-bordered table-hover" PagerStyle-CssClass="paginate_button active" DataKeyField="Id"
            GridLines="None"
            OnCancelCommand="dgVehicle_CancelCommand" OnDeleteCommand="dgVehicle_DeleteCommand" OnEditCommand="dgVehicle_EditCommand"
            OnItemCommand="dgVehicle_ItemCommand" OnItemDataBound="dgVehicle_ItemDataBound" OnUpdateCommand="dgVehicle_UpdateCommand"
            ShowFooter="True">
            ...
            <Columns>
                <asp:TemplateColumn HeaderText="Plate No.">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtEdtPlateNo" runat="server" CssClass="form-control" Text=' <%# DataBinder.Eval(Container.DataItem, "PlateNo")%>'></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="validator" ControlToValidate="txtEdtPlateNo" ErrorMessage="Plate No Required" ValidationGroup="1">*</asp:RequiredFieldValidator>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="txtPlateNo" runat="server" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="validator" ControlToValidate="txtPlateNo" ErrorMessage="Plate No. Required" ValidationGroup="2">*</asp:RequiredFieldValidator>
                    </FooterTemplate>
                </asp:TemplateColumn>
