        ...
        public IList<CashPaymentRequest> ListCashPaymentRequests(string RequestNo, string RequestDate, string ProgressStatus)
        {
            ...
            else if (ProgressStatus == "Completed")
            {
                filterExpression = " SELECT * FROM CashPaymentRequests " +
                                   ...
                                   " AND CashPaymentRequests.CurrentStatus != 'Rejected' ORDER BY CashPaymentRequests.Id DESC";
        ...
        public IList<OperationalControlRequest> ListOperationalControlRequests(string RequestNo, string RequestDate, string ProgressStatus)
        {
            ...
            else if (ProgressStatus == "Completed")
            {
                filterExpression = " SELECT * FROM OperationalControlRequests " +
                                   ...
                                   " AND OperationalControlRequests.CurrentStatus != 'Rejected' ORDER BY OperationalControlRequests.Id DESC ";
            }
        ...
        public IList<TravelAdvanceRequest> ListTravelAdvanceRequests(string RequestNo, string RequestDate, string ProgressStatus)
        {
            ...
            else
            {
                filterExpression = " SELECT * FROM TravelAdvanceRequests " +
                                   ...
                                   " AND TravelAdvanceRequests.ProgressStatus='" + ProgressStatus + "' AND TravelAdvanceRequests.CurrentStatus != 'Rejected'" +
