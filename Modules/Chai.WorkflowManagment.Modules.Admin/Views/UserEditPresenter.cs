...
namespace Chai.WorkflowManagment.Modules.Admin.Views
{
    public class UserEditPresenter : Presenter<IUserEditView>
    {
        ...
        public void SaveOrUpdateUser()
        {
            ...
            if (user.Id <= 0)
                EmailSender.Send(user.PersonalEmail, "Welcome to the CHAI ERP System", "Hello " + (user.FullName).ToUpper() + "You can access the ERP system using your username " + user.UserName + " and your password " + user.Password + " by clicking the following link");
