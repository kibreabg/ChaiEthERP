...
{
    public class frmEmployeebirthPresenter : Presenter<IfrmEmployeebirthView>
    {
        ...
        public frmEmployeebirthPresenter([CreateNew] Chai.WorkflowManagment.Modules.Report.ReportController controller)
        {
        ...
        public DataSet EmployeeBirthReport(string month)
        {
            ...
            return _controller.EmployeeBirthReport(month);
        }
