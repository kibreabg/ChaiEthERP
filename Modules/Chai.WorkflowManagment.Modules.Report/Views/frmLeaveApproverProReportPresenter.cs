...
{
    public class frmLeaveApproverProReportPresenter : Presenter<IfrmLeaveApproverProReportView>
    {
        ...
        public frmLeaveApproverProReportPresenter([CreateNew] Chai.WorkflowManagment.Modules.Report.ReportController controller, AdminController adminController, SettingController settingController)
        {
        ...
        {
            return _controller.LeaveApproverProgressReport();
        }
