...
namespace Chai.WorkflowManagment.Shared.MailSender
{
    ...
    public class EmailSender
    {
        ...
        public static bool Send(string to, string subject, string body)
        {
            ...
            message.AppendLine("<table border='0' cellpadding='0' cellspacing='0' class='btn btn-primary'><tbody><tr><td align='left'><table border='0' cellpadding='0' cellspacing='0'><tbody><tr><td> <a href='http://10.143.1.25/' target='_blank'>Click here</a></td></tr></tbody></table></td></tr></tbody></table></td></tr></table></td></tr></table>");
